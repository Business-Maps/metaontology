...
export const ENUM_TYPES: readonly (EnumDef | UnionDef | TypeAliasDef)[] = [
  ...
  {
    name: 'MediaRef',
    description: 'Media attachment - either an uploaded blob or an external URL',
    variants: [
...
export const INTERFACE_TYPES: readonly InterfaceDef[] = [
...

  {
    ...
    fields: [
      ...
      { name: 'attachment', type: 'MediaRef', optional: true, description: 'Optional pasted/dropped media attachment (image, video, audio)' },
    ],
  },
